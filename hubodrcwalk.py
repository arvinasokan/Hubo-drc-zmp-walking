...
def dynshiftleft():
  ...
  for i in range (0,500):
    ...
    r.put(ref) 
def liftright():
  (h,k,a)=IK(500,0)#IK for the required End effector position
  (h1,k1,a1)=IK(550,0)#IK values of the previous end effector position
...
def liftleft():#previous IK value is passed, to find the difference between the two values 
  (h,k,a)=IK(500,0)#IK value for the required leg position
  (h1,k1,a1)=IK(550,0)
  ##print h1,k1,a1 
  d1=h1-h
  d2=k1-k
...
def walkbackward():
  ...
  leftstep(50)
  dynshiftleft1(50)  
print 'Press i to initialize or q to quit'
